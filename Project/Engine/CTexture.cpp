...
void CTexture::Clear()
{
	...
	UINT i = -1;
	CONTEXT->VSSetShaderResources(m_iRecentCSNum, 1, &pSRV);
	CONTEXT->HSSetShaderResources(m_iRecentCSNum, 1, &pSRV);
	CONTEXT->DSSetShaderResources(m_iRecentCSNum, 1, &pSRV);
	CONTEXT->GSSetShaderResources(m_iRecentCSNum, 1, &pSRV);
	CONTEXT->PSSetShaderResources(m_iRecentCSNum, 1, &pSRV);	
}
...
void CTexture::Clear_CS(bool _bShaderRes)
{
	...
	{
		ID3D11ShaderResourceView* pSRV = nullptr;
		CONTEXT->CSSetShaderResources(m_iRecentCSNum, 1, &pSRV);
	}
	else
	{
