...
int CDevice::init(HWND _hWnd, UINT _iWidth, UINT _iHeight)
{
    ...
    {
        MessageBox(nullptr, L"Device, Context Create FAILED", L"Device Initialize Error", MB_OK);
        return E_FAIL;
    }

    if (FAILED(CreateSwapChain()))
    {
        MessageBox(nullptr, L"SwapChain Create FAILED!!", L"Device Initialize Error", MB_OK);
        return E_FAIL;
    }

    if (FAILED(CreateView()))
    {
        MessageBox(nullptr, L"View Create FAILED", L"Device Initialize Error", MB_OK);
        return E_FAIL;
    }
    ...
    {
        MessageBox(nullptr, L"RasterizerState Create FAILED!!", L"Device Initialize Error", MB_OK);
        return E_FAIL;
    }

    if (FAILED(CreateDepthStencilState()))
    {
        MessageBox(nullptr, L"DepthStencilState Create FAILED!!", L"Device Initialize Error", MB_OK);
        return E_FAIL;
    }

    if (FAILED(CreateBlendState()))
    {
        MessageBox(nullptr, L"BlendState Create FAILED!!", L"Device Initialize Error", MB_OK);
        return E_FAIL;
    }

    if (FAILED(CreateSampler()))
    {
        MessageBox(nullptr, L"Sampler Create FAILED!!", L"Device Initialize Error!!", MB_OK);
        return E_FAIL;
    }
